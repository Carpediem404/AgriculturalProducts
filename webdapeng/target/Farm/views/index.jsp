...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-2">
            <img src="agro/UIpic/agrologo.png" style="height:100px">
        </div>
    </div>
    <br>
    <form id="signInForm" name="form"
        ...
        <div class="row">
            ...
            <div class="col-md-8 col-md-offset-2" style="background-color:rgba(80,77,77,0.3);height:300px">
                <div class="biaoti">
                    登&nbsp;录
                </div>
                <div class="form-group">
                    <label class="col-md-2 col-md-offset-3  normalfonts">&nbsp;&nbsp;&nbsp;用户名</label>
                    <div class="col-md-4">
                ...
                <div class="form-group">
                    <label class="col-md-2 col-md-offset-3  normalfonts">&nbsp;&nbsp;&nbsp;密&nbsp;&nbsp;&nbsp;&nbsp;码</label>
                    <div class="col-md-4">
                ...
                <div class="row">
                    <div class="col-md-2 col-sm-offset-5">
                        <button type="submit" name="submit" class="btn  btn-primary btn-info btn-block"
                ...
                <div class="row">
                    <div style="text-align:center">
                        <p style="color:#FFFFFF">没有账号，前往 <a style="color:#E3E3E3" href="views/sign-up.jsp">注册</a></p>
                    </div>
                </div>
            </div>
        </div>
