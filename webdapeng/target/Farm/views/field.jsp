    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">大棚添加</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal">
                    <div class="form-group">
                        <label class="col-sm-2 control-label">大棚面积（平方米）</label>
                        <div class="col-sm-10">
        ...
        <div class="col-md-9">
            ...
            <div class="col-md-12" style="background-color:rgba(80,77,77,0.7);height:100%;color:#FFFFFF">
                <div class="row" style="height:50px">
                    <div class="col-md-3" style="margin-top:10px;text-align:center;font-size:20px">大棚信息管理</div>
                        ...
                        <div class="col-md-12">
                            <table class="table table-hover" id="field_table">
                                ...
                                <tr style="color: #ffffff">
                                    ...
                                    <th style="text-align:center">空气温度（℃）</th>
                                    <th style="text-align:center">空气湿度</th>
                                    <th style="text-align:center">二氧化碳浓度（PPM）</th>
                                    <th style="text-align:center">光照度（lx）</th>
                                    <th style="text-align:center">土壤温度（℃）</th>
                                    <th style="text-align:center">土壤湿度</th>
...
<script type="text/javascript">
    ...
    function build_field_table(result) {
        ...
        $.each(field, function (index, item) {
            ...
            var air_temperatureTd = $("<td></td>").append(item.air_temperature);
            var air_humidityTd = $("<td></td>").append(item.air_humidity);
            var co2Td = $("<td></td>").append(item.co2);
            var illuminanceTd = $("<td></td>").append(item.illuminance);
            var soil_temperatureTd = $("<td></td>").append(item.soil_temperature);
            var soil_humidityTd = $("<td></td>").append(item.soil_humidity);
            ...
            $("<tr></tr>").append(checkBoxTd)
                ...
                .append(statusTd)
                .append(totalTd)
                .append(air_temperatureTd)
                .append(air_humidityTd)
                .append(co2Td)
                .append(illuminanceTd)
                .append(soil_temperatureTd)
                .append(soil_humidityTd)
                .append(btnTd)
